...
class BookObject<T extends TreeObject, U extends TreeObject> extends TreeObject {
  ...
  static BookObject<T, U> fromJson<T extends TreeObject, U extends TreeObject>(String json, Deserializer<T> deserializer_T, Deserializer<U> deserializer_U) {
    try {
    ...
    try {
      return BookObject.t(deserializer_T(json));
    } catch (_) {
    try {
  ...
  static BookObject<T, U> fromYaml<T extends TreeObject, U extends TreeObject>(String yaml, Deserializer<T> deserializer_T, Deserializer<U> deserializer_U) {
    try {
    ...
    try {
      return BookObject.t(deserializer_T(yaml));
    } catch (_) {
    try {
