...
class Content extends TreeObject {
  ...
  const Content({required this.body, this.wordCount, super.sourceRange, super.jsonFormatting, super.yamlFormatting});
...
class CommentsList extends ListObject<Comment> {
  CommentsList(
    ...
    super.jsonFormatting,
    super.yamlFormatting,
    super.jsonArrayStyle,
    super.yamlSequenceStyle,
  });
}
